...
os.makedirs(f"./{ct_name}_cell_5_mean_mx", exist_ok = True)
os.chdir(f"./{ct_name}_cell_5_mean_mx")

# define paths to data
plink_prefix_path = f"/directflow/SCCGGroupShare/projects/angxue/data/onek1k/genotype/plink_chr{chr_num}"
expression_bed = f"/share/ScratchGeneral/angxue/proj/vQTL/TensorQTL/expression/cell_5_mean_mx/{ct_name}/OneK1K_980_samples_{ct_name}_chr{chr_num}.bed.gz"
...
interaction_s = covariates_df.loc[:, ['sex']]
covariates_df = covariates_df.drop('sex', axis=1)
