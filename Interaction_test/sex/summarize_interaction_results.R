...
for(i in 1:22){
file_name = paste0("/share/ScratchGeneral/angxue/proj/vQTL/TensorQTL/interaction/sex/",new_names[k],"_cell_5_dispersion_mx/OneK1K_",new_names[k],"_chr",i,".cis_qtl_top_assoc.txt.gz")
...
write.table(data, "deQTL_interaction_sex_results.txt", row.names=F,col.names=T,quote=F)
