...
rm eQTL_OneK1K_cell_5_mean_mx_${new_names[i]}.qsub
rm eQTL_OneK1K_cell_5_variance_mx_${new_names[i]}.qsub
rm eQTL_OneK1K_cell_5_dispersion_mx_${new_names[i]}.qsub
