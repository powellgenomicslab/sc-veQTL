...
# mx = fread(paste0("/share/ScratchGeneral/angxue/proj/vQTL/mean_var_matrix/mean_variance_relationship/linear_reg/",ct_name,"_cells_residual_mx.txt"), header = T)
# mx = as.data.frame(mx)

mx = fread(paste0("/share/ScratchGeneral/angxue/proj/vQTL/mean_var_matrix/estimate_ZINB_params/mle/within_ind_results/unshrunk_dispersion/",ct_name,"_cells_dispersion_mx.txt"), header = T)
mx = as.data.frame(mx)
mx = mx[,-1]
mx = mx[, -index]
